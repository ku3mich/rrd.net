...
public class UnitTest
{
    ...
    public void Test1()
    {
        ...
        RrdDef rrdDef = new("test1.rrd")
        {
            StartTime = 978300900L
        };
    ...
    public void Test2()
    {
        ...
        RrdDef rrdDef = new("test2.rrd")
        {
            StartTime = 920804400L
        };
    ...
    public void Test3()
    {
        ...
        RrdDef rrdDef = new(rrdFile, start - 1, 300);
    ...
    public void Test4()
    {
        ...
        LinearInterpolator linear = new(timestamps, values);
        CubicSplineInterpolator spline = new(timestamps, values);

        // graph range
        RrdGraphDef gDef = new(timestamps[0], timestamps[timestamps.Length - 1])
        {
            // graph title, time and value axis labels
            Title = "Plottable demonstration",
            TimeAxisLabel = "time",
            VerticalLabel = "water level [inches]"
        };
    ...
    public void StressTest()
    {
        ...
        RrdGraphDef gdef = new(TIME_START, TIME_END)
        {
            Title = "Temperatures",
    ...
    private void PrintLapTime(string message)
    {
